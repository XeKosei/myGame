...
namespace nsHikageri
{
	namespace nsPlayer
	{
		...
		{
			static const Vector3 INI_PLAYER_POSITION = { -8000.0f,0.0f,0.0f };	//プレイヤーの初期位置
		...
		{
			static const std::wstring ITEM_NAME[PlayerPouch::enItem_num] = { L"電池", L"精神安定剤" , L"赤色の鍵", L"青色の鍵", L"緑色の鍵", L"黄色の鍵", L"紫色の鍵"};
