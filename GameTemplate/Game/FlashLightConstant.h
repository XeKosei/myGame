...
namespace nsHikageri
{
	namespace nsFlashLight
	{
		...
		{
			static const Vector3 INI_FLASHLIGHT_COLOR = { 2.0f,2.0f,2.0f };	//懐中電灯の初期カラー
			...
			static const Vector3 FLASHLIGHT_POS_APPLY_VALUE = { 50.0f, -50.0f, 0.0f };	//懐中電灯の本当の位置を計算するための値
